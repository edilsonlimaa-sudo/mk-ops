  ...
  return (
    ...
    >
      <View className="flex-1 bg-sky-50">
        {/* Header Celebrativo */}
        <View className="bg-sky-600 px-6 pt-14 pb-8">
          <View className="flex-row items-center justify-between mb-4">
            <View className="flex-1">
              <Text className="text-xl font-bold text-white mb-1">Fechar Chamado</Text>
              <Text className="text-sky-100 text-sm">Informe o motivo para finalizar</Text>
            </View>
          ...
          <View className="items-center">
            <View className="bg-white/20 w-20 h-20 rounded-full items-center justify-center">
              <View className="bg-white w-16 h-16 rounded-full items-center justify-center">
                <Ionicons name="checkmark-done-circle" size={32} color="#0284c7" />
              </View>
            </View>
          </View>
        </View>
          ...
          <View className="px-6 py-6 pb-8">
            ...
            <View className="bg-white rounded-2xl p-5 mb-4 shadow-sm border border-gray-100">
              <View className="flex-row items-center mb-4">
                ...
                <View className="flex-1">
                  <Text className="text-base font-bold text-gray-900">Motivo do Fechamento</Text>
                  <Text className="text-xs text-gray-500">Chamado #{numeroChamado}</Text>
                </View>
              </View>

              {/* Lista de Motivos Padrão - Grid 2 Colunas */}
              <View className="mb-4">
                <Text className="text-sm font-semibold text-gray-700 mb-3">Selecione um motivo:</Text>
              ...
              <View className="flex-row justify-between items-center mt-2 px-1">
                ...
                {motivo.length > 0 && (
                  <View className="flex-row items-center gap-1">
                    ...
                    <Text className="text-xs text-sky-600 font-semibold">Pronto!</Text>
                  </View>
                )}
              </View>
            </View>
            ...
            <View className="bg-white rounded-2xl p-4 border border-gray-100">
              ...
              <TouchableOpacity
                ...
                disabled={fechaChamadoMutation.isPending}
                className="bg-sky-600 py-4 rounded-2xl mb-3 shadow-lg"
              >
